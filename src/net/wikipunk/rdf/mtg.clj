...
(def Abian
  "Abian"
  {:db/ident   :mtg/Abian,
   :rdf/type   [:mtg/Planeswalker :owl/NamedIndividual],
   :rdfs/label "Abian"})
...
(def Adventure
  ...
  {:db/ident   :mtg/Adventure,
   :rdf/type   [:mtg/Spell :owl/NamedIndividual],
   :rdfs/label "Adventure"})

(def Advisor
  "Advisor"
  {:db/ident   :mtg/Advisor,
   :rdf/type   [:mtg/Creature :owl/NamedIndividual],
   :rdfs/label "Advisor"})
...
(def Alara
  "Alara"
  {:db/ident   :mtg/Alara,
   :rdf/type   [:mtg/Plane :owl/NamedIndividual],
   :rdfs/label "Alara"})
...
(def Attraction
  ...
  {:db/ident   :mtg/Attraction,
   :rdf/type   [:mtg/Artifact :owl/NamedIndividual],
...
(def Aura
  "Aura"
  {:db/ident   :mtg/Aura,
   :rdf/type   [:mtg/Enchantment :owl/NamedIndividual],
   :rdfs/label "Aura"})
...
(def Cloud
  "Cloud"
  {:db/ident   :mtg/Cloud,
   :rdf/type   [:mtg/Land :owl/NamedIndividual],
   :rdfs/label "Cloud"})
...
(def Dungeon
  ...
  {:db/ident            :mtg/Dungeon,
   ...
   :rdf/type            [:mtg/Planeswalker :owl/NamedIndividual :owl/Class],
   :rdfs/label          "Dungeon",
   :rdfs/subClassOf     :mtg/CardType})
...
(def abilityWord
  ...
  {:db/cardinality :db.cardinality/one,
   ...
   :rdfs/label     "abilityWord",
   :rdfs/range     :mtg/AbilityWord})
...
(def manaCost
  ...
  {:db/cardinality :db.cardinality/many,
   ...
   :rdf/type       :owl/ObjectProperty,
   :rdfs/domain    :mtg/Card,
   :rdfs/label     "mana cost and color",
   :rdfs/range     :mtg/Mana})
